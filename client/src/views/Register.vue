    ...
    <div class="register">
        <section class="form_container">
            <div class="manage_tip">
                ...
                <el-form :model="registerUser" :rules="rules" ref="registerForm" label-width="80px" class="registerForm" autocomplete="off">
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post("/api/users/register", this.registerUser).then((res, req)=>{
                            // register success
                            this.$message({
                                message: "账号注册成功！",
                                type: "success"
